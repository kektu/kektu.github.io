...
*/
    ...
    if (!document.getElementById('maxsm_ratings')) {
        ...
        OMDB_API_KEYS = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.OMDB_API_KEYS) || ['c4fe9fcf']; // api ключи массивом
        KP_API_KEYS = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.KP_API_KEYS) || ['cc0875d7-b351-46bb-b97f-56787d2ea25d']; // api ключи массивом
