    ...
    function startPlugin() {
        ...
        var menuItem = $(
            '<li class="menu__item selector" data-action="' + PLUGIN_NAME + '">' +
                ...
                '<div class="menu__text">' + Lampa.Lang.translate('novinki_title') + '</div>' +
            '</li>'
        );
        ...
        menuItem.on("hover:enter", function() {
            Lampa.Activity.push({
                ...
                source: PLUGIN_NAME,
                title: Lampa.Lang.translate('novinki_title'),
                page: 1,
        ...
        var clearCacheItem = $(
            '<li class="menu__item selector" data-action="clear_novinki_cache">' +
