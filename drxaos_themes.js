...
poster_border_width: { ru: 'Толщина обводки', en: 'Border Width', uk: 'Товщина обведення' },
poster_border_width_desc: { ru: 'Толщина рамки вокруг постеров', en: 'Border width around posters', uk: 'Товщина рамки навколо постерів' },
poster_border_radius: { ru: 'Скругление углов', en: 'Corner Radius', uk: 'Закруглення кутів' },
poster_border_radius_desc: { ru: 'Степень скругления углов постеров', en: 'Poster corner rounding level', uk: 'Ступінь закруглення кутів постерів' },
    ...
    setTimeout(function() {
        ...
        setInterval(function() {
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (borderColor && (
                    borderColor.includes('255, 255, 255') ||
...
function addSettings() {
    ...
    Lampa.SettingsApi.addParam({
        ...
        field: {
        name: Lampa.Lang.translate('poster_border_width'),
        description: Lampa.Lang.translate('poster_border_width_desc')
    },
        onChange: function(v) {
    ...
    Lampa.SettingsApi.addParam({
        ...
        field: {
        name: Lampa.Lang.translate('poster_border_radius'),
        description: Lampa.Lang.translate('poster_border_radius_desc')
    },
        onChange: function(v) {
